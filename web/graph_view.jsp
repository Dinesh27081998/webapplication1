  ...
  <div id="main">
	...
	<div id="menubar">
      <ul id="menu">
        ...
        <li><a href="c.html">References</a></li> -->
      </ul>
    </div><!--close menubar-->	
	...
	<div id="site_content">		
	  ...
	  <div class="slideshow">
	    <ul class="slideshow">
          <li class="show"><img width="680" height="250" src="images/home_1.jpg" alt="&quot;Be Aware Be Secure here&quot;" /></li>
	  ...
	  <div id="content">
		...
		<font size="5" color="white">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Graph</font>
...
<table>
			...
			<table>
			<tr>
			<td><img src="Graph/filter.jpg" alt="cover_main" width="550" height="350" /></td>
			</tr>
			</table>
